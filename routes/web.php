...
Route::post('/novo-requerimento', function(Request $request) {
    ...
    return redirect()->route('newRequisition')->with('success', ['title message' => 'Requerimento criado', 'body message' => 'O requerimento foi criado com sucesso. Acompanhe o andamento pela página inicial.']);
