...
return [
    ...
    */
    ...
    'attributes' => [
        'requisitionId' => 'ID do requerimento',
        'result' => 'resultado',
        'result_text' => 'justificativa',
        'student_name' => 'nome do estudante',
        'email' => 'email',
        'student_nusp' => 'número USP',
        'course' => 'curso',
        'requestedDiscName' => 'nome da disciplina solicitada',
        'requestedDiscType' => 'tipo da disciplina solicitada',
        'requestedDiscCode' => 'código da disciplina solicitada',
        'requestedDiscDepartment' => 'departamento da disciplina solicitada',
        'takenDiscRecord' => 'histórico das disciplinas cursadas',
        'courseRecord' => 'histórico do curso',
        'takenDiscSyllabus' => 'ementa das disciplinas cursadas',
        'requestedDiscSyllabus' => 'ementa da disciplina solicitada',
        'takenDiscCount' => 'quantidade de disciplinas cursadas',
        'observations' => 'observações',
        'takenDiscNames.*' => 'nome da disciplina cursada',
        'takenDiscCodes.*' => 'código da disciplina cursada',
        'takenDiscYears.*' => 'ano da disciplina cursada',
        'takenDiscGrades.*' => 'nota da disciplina cursada',
        'takenDiscSemesters.*' => 'semestre da disciplina cursada',
        'takenDiscInstitutions.*' => 'instituição da disciplina cursada',
    ],
];
